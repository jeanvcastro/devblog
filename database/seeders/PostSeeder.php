...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $distribuidos = \App\Models\Tag::where(
            "slug",
        ...
        $posts = [
            [
                "title" =>
                    "Design de Sistemas Distribuídos: Patterns e Anti-patterns",
                ...
                "excerpt" =>
                    "Explorando os principais patterns e anti-patterns em sistemas distribuídos modernos.",
                "status" => "published",
            ...
            [
                "title" =>
                    "Event Sourcing: Implementação Prática com TypeScript",
                ...
                "excerpt" =>
                    "Como implementar Event Sourcing usando TypeScript na prática.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Análise detalhada sobre quando adotar arquitetura de micro-frontends.",
                "status" => "published",
            ...
            [
                "title" =>
                    "Otimização de Performance em React: Além do useMemo",
                ...
                "excerpt" =>
                    "Técnicas avançadas de otimização além dos hooks básicos de memoization.",
                "status" => "published",
            ...
            [
                "title" =>
                    "Arquitetura Hexagonal: Clean Architecture na Prática",
                ...
                "excerpt" =>
                    "Implementando Clean Architecture com Hexagonal Architecture.",
                "status" => "published",
            ...
            [
                "title" =>
                    "WebSockets vs Server-Sent Events: Escolhendo a Tecnologia Certa",
                ...
                "excerpt" =>
                    "Comparação prática entre WebSockets e Server-Sent Events.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Explorando estratégias de sharding e seus trade-offs.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Como construir pipelines CI/CD eficientes e confiáveis.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Como criar testes de integração robustos com Testcontainers.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Comparação prática entre Zustand e Redux para gerenciamento de estado.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Implementando autenticação JWT de forma segura e eficiente.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Implementando rate limiting eficiente em APIs REST.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Comparando abordagens modernas de estilização em React.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Comparação entre RabbitMQ e Kafka para mensageria.",
                "status" => "published",
            ...
            [
                ...
                "excerpt" =>
                    "Implementando Factory e Builder patterns em TypeScript.",
                "status" => "draft",
                "published_at" => null,
                "author_id" => $admin->id,
                "reading_time" => 7,
